 ...
 *============================================================================*/
BasicBlock *Cfg::splitBB(BasicBlock *pBB, ADDRESS uNativeAddr, BasicBlock *pNewBB /* = 0 */, bool bDelRtls /* = false */)
{
 ...
 * RETURNS:         <nothing>
 *============================================================================*/
void Cfg::completeMerge(BasicBlock *pb1, BasicBlock *pb2, bool bDelete = false)
{
