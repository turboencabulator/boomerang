/**
 * \file
 * \brief Skeleton file for a disassembler of SPARC instructions.
 *
 * \authors
...
/**
 * Decodes a register or an immediate value.
 *
 * \param pc  Address to be decoded.
 * \returns   String with information about register or immediate.
 */
char *
NJMCDecoder::dis_RegImm(ADDRESS pc)
{
...
/**
 * Decodes an effective address.
 *
 * \param pc  Address to be decoded.
 * \returns   String with effective address in assembly format.
 */
char *
NJMCDecoder::dis_Eaddr(ADDRESS pc)
{
...
/**
 * Decodes a machine instruction and displays its assembly representation onto
 * the external array _assembly[].
 *
 * \param pc     The native address of the pc.
 * \param delta  The difference between the native address and the host
 *               address of the pc.
 *
