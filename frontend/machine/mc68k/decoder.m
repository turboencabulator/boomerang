 ...
 *============================================================================*/
DecodeResult &
NJMCDecoder::decodeInstruction(ADDRESS pc, int delta, UserProc *proc = NULL)
{
	...
	} else if ((logue = InstructionPatterns::near_call(csr, hostPC, addr)) != NULL) {
		/*
	...
	} else if ((logue = InstructionPatterns::pea_pea_add_rts(csr, hostPC, d32)) != NULL) {
		/*
	...
	} else if ((logue = InstructionPatterns::pea_add_rts(csr, hostPC, d32)) != NULL) {
		/*
	...
	} else if ((logue = InstructionPatterns::trap_syscall(csr, hostPC, d16)) != NULL) {
		/*
	 ...
	 * CALLEE PROLOGUES
	 */
	else if ((logue = InstructionPatterns::link_save(csr, hostPC, locals, d16)) != NULL) {
		/*
	...
	} else if ((logue = InstructionPatterns::link_save1(csr, hostPC, locals, reg)) != NULL) {
		/*
	...
	} else if ((logue = InstructionPatterns::push_lea(csr, hostPC, locals, reg)) != NULL) {
		/*
	...
	} else if ((logue = InstructionPatterns::std_link(csr, hostPC, locals)) != NULL) {
		/*
		 * Standard link
		 */
		if (proc != NULL) {
		...
		result.numBytes = hostPC - saveHostPC;
		SHOW_ASM("pop_ret")
	} else if ((logue = InstructionPatterns::clear_stack(csr, hostPC, stackSize)) != NULL) {
		/*
...
void
NJMCDecoder::pIllegalMode(ADDRESS pc)
{
	ostrstream ost;
...
SemStr *
NJMCDecoder::pPostInc(int r2, int &bump, int &bumpr, int size)
{
...
SemStr *
NJMCDecoder::pPreDec(int r2, int &bump, int &bumpr, int size)
{
...
SemStr *
NJMCDecoder::pAbsW(int d16, int size)
{
...
void
NJMCDecoder::pNonzeroByte(ADDRESS pc)
{
	ostrstream ost;
...
SemStr *
NJMCDecoder::alEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::amEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int delta, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::awlEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int delta, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::cEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int delta, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::dEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int delta, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::daEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::dBEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int delta, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::dWEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int delta, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::maEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::msEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int delta, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::msEAXL(ADDRESS eaxl, int d32, DecodeResult &result, ADDRESS pc, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::mdEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int size)
{
	SemStr *ret;
	int reg1, mode;
...
SemStr *
NJMCDecoder::mrEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int delta, int size)
{
	SemStr *ret;
	int reg2, mode;
...
SemStr *
NJMCDecoder::rmEAX(ADDRESS eax, ADDRESS x, DecodeResult &result, ADDRESS pc, int size)
{
	SemStr *ret;
	int reg2, mode;
 ...
 *============================================================================*/
bool
isFuncPrologue(ADDRESS hostPC)
{
	int locals, reg, d16;

	if ((InstructionPatterns::link_save(prog.csrSrc, hostPC, locals, d16)) != NULL)
		return true;
	if ((InstructionPatterns::link_save1(prog.csrSrc, hostPC, locals, reg)) != NULL)
		return true;
	if ((InstructionPatterns::push_lea(prog.csrSrc, hostPC, locals, reg)) != NULL)
		return true;
